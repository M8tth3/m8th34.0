...
Which of the following is true:
	...
	A - Allowing students to bring their computers to school would help reduce the digital divide. TRUE

	B - A study showing that men and women use Snapchat in the same proportion is an example of the digital divide. FALSE

	C - Low-cost satellite internet services for places where internet connectivity has been unreliable and can help reduce the digital divide. TRUE

	D - An online software business is failing as a result of the digital divide. TRUE
...
Which of the following school policies is most likely to have a positive impact on the digital divide? Explain your answer.
    ...
    C - A school provides a laptop or tablet computer to all students enrolled at the school. 
        C, because providing everyone with a computer means that all students have access to technology which will reduce the digital divide between low income students and students with more money.
...
To bridge the digital divide, you can contribute by advocating for policies which implement affordable internet access and you can promote digital literacy. You can also make partnerships with organizations who work towards this goal and support initiatives that provide affordable technology.~
