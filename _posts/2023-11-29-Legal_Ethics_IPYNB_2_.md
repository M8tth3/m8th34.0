...
1. Describe the key differences between the Creative Commons Zero v1.0 Universal, Open Source MIT License, and Open Source GPL License.
   1. CC1.0
      1. Used mainly for creative works like images or art or music
      2. Anyone can use the work without restrictions
   2. MIT
      1. Used as an open source software license
      2. You can do anything but include the license
   3. Open Source GPL
      1. Copyleft license, which means that any derivative work must also be open source
      2. You can use the code and any code released using the previous one also has to be open source
2. Give examples that illustrate how companies, such as Qualcomm and Red Hat, have leveraged Open Source licenses to establish unique business models.
   1. Comanies can use open source licenses to spread software. For example, Android is free and open source so any company can use this on their phone unlike IOS which is closed source and this is why android is on more devices.
3. Why are businesses that heavily rely on Open Source software still need to generate income and how they manage this within the constraints of Open Source licenses.
   1. They need to generate income and they can do this by making freeware. So Ubuntu is open source but other services are paid.
...
Choosing the correct license is important because it provides legal clarity, allows for open source collaboration, adresses ethical concerns, and tells what others can or cannot do with the project including yourself.
